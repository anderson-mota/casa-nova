...
angular.module('myApp.controllers', [])
    .controller('Main', ['$scope', function() {
        ...
        var $touchCarousel = $('.touch-carousel');
        $touchCarousel.find('.owl-prev').html('<i class="fa fa-angle-left"></i>');
        $touchCarousel.find('.owl-next').html('<i class="fa fa-angle-right"></i>');
        ...
        var $camera_wrap_3 = $('#camera_wrap_3');
